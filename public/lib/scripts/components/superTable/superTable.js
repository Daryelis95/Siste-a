...
angular.module("superTable", []).component("superTable", {
...
function SuperTableCtrl($scope) {
  ...
  this.$onInit = function () {
    ...
    function configPages() {
      ...
      if (ini < 1) {
        ini = 1;
        if (Math.ceil($ctrl.data.length / $scope.pageSize) > 10) fin = 10;else fin = Math.ceil($ctrl.data.length / $scope.pageSize);
      } else {
...
//# sourceMappingURL=superTable.js.map
