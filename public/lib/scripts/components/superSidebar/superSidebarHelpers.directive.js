...
(function () {
  ...
  angular.module('superSidebar').directive('superSidebarToggleMenu', superSidebarToggleMenu).directive('baSidebarToggleMenu', baSidebarToggleMenu).directive('baSidebarCollapseMenu', baSidebarCollapseMenu).directive('baSidebarTogglingItem', baSidebarTogglingItem).controller('BaSidebarTogglingItemCtrl', BaSidebarTogglingItemCtrl).directive('baUiSrefTogglingSubmenu', baUiSrefTogglingSubmenu).directive('baUiSrefToggler', baUiSrefToggler);
...
//# sourceMappingURL=superSidebarHelpers.directive.js.map
