...
!function (t, e) {
  ...
  t.module("smart-table", []).run(["$templateCache", function (t) {
    ...
    function i(t) {
      ...
      if (-1 != e.indexOf(".")) {
        var a = e.split("."),
            s = a.pop(),
            r = a.join("."),
            i = n(r)(t);delete i[s], 0 == Object.keys(i).length && l(t, r);
      } else delete t[e];
    }var o,
        u,
        p,
        ...
        h = s("filter"),
        b = i(d(a)),
        v = { sort: {}, search: {}, pagination: { start: 0, totalItemCount: 0 } },
        S = !0,
        P = this;r.stSafeSrc && (o = n(r.stSafeSrc), a.$watch(function () {
      var t = o(a);return t && t.length ? t[0] : e;
    }, function (t, e) {
      t !== e && c();
    }), a.$watch(function () {
      var t = o(a);return t ? t.length : 0;
    }, function (t, e) {
      t !== b.length && c();
    }), a.$watch(function () {
      return o(a);
      ...
      var s = v.search.predicateObject || {},
          r = e || "$";return n(r).assign(s, t), t || l(s, r), v.search.predicateObject = s, v.pagination.start = 0, this.pipe();
    }, this.pipe = function () {
      var t,
          n = v.pagination;u = v.search.predicateObject ? h(b, v.search.predicateObject) : b, v.sort.predicate && (u = m(u, v.sort.predicate, v.sort.reverse)), n.totalItemCount = u.length, n.number !== e && (n.numberOfPages = u.length > 0 ? Math.ceil(u.length / n.number) : 1, n.start = n.start >= u.length ? (n.numberOfPages - 1) * n.number : n.start, t = u.slice(n.start, n.start + parseInt(n.number))), f(a, t || u);
    }, this.select = function (t, n) {
      var s = i(d(a)),
          r = s.indexOf(t);-1 !== r && ("single" === n ? (t.isSelected = !0 !== t.isSelected, p && (p.isSelected = !1), p = !0 === t.isSelected ? t : e) : s[r].isSelected = !s[r].isSelected);
    ...
    return { restrict: "A", controller: "stTableController", link: function link(t, e, a, n) {
    ...
    return { require: "^stTable", link: function link(s, r, i, c) {
        var l = c,
            o = null,
            u = i.stDelay || e.search.delay,
            p = i.stInputEvent || e.search.inputEvent,
            g = i.trimSearch || e.search.trimSearch;i.$observe("stSearch", function (e, a) {
          var n = r[0].value;e !== a && n && (c.tableState().search = {}, n = t.isString(n) && g ? n.trim() : n, l.search(n, e));
        }), s.$watch(function () {
          return c.tableState().search;
        }, function (t, e) {
          var a = i.stSearch || "$";t.predicateObject && n(a)(t.predicateObject) !== r[0].value && (r[0].value = n(a)(t.predicateObject) || "");
        }, !0), r.bind(p, function (e) {
          e = e.originalEvent || e, null !== o && a.cancel(o), o = a(function () {
            var a = e.target.value;a = t.isString(a) && g ? a.trim() : a, l.search(a, i.stSearch || ""), o = null;
          }, u);
        });
      } };
  }]), t.module("smart-table").directive("stSelectRow", ["stConfig", function (t) {
    return { restrict: "A", require: "^stTable", scope: { row: "=stSelectRow" }, link: function link(e, a, n, s) {
        var r = n.stSelectMode || t.select.mode;a.bind("click", function () {
          e.$apply(function () {
            s.select(e.row, r);
          });
    ...
    return { restrict: "A", require: "^stTable", link: function link(r, i, c, l) {
        function o() {
          v ? d = 0 === d ? 2 : d - 1 : d++;var e;p = t.isFunction(g(r)) || t.isArray(g(r)) ? g(r) : c.stSort, d % 3 == 0 && !0 != !!b ? (d = 0, l.tableState().sort = {}, l.tableState().pagination.start = 0, e = l.pipe.bind(l)) : e = l.sortBy.bind(l, p, d % 2 == 0), null !== S && s.cancel(S), P < 0 ? e() : S = s(function () {
            e();
          }, P);
        }var u,
            p = c.stSort,
            g = n(p),
            d = 0,
            f = c.stClassAscent || a.sort.ascentClass,
            m = c.stClassDescent || a.sort.descentClass,
            h = [f, m],
            b = c.stSkipNatural !== e ? c.stSkipNatural : a.sort.skipNatural,
            v = c.stDescendingFirst !== e ? c.stDescendingFirst : a.sort.descendingFirst,
            S = null,
            P = c.stDelay || a.sort.delay,
            y = "aria-sort";i.attr("role", "columnheader").attr(y, "none"), c.stSortDefault && (u = r.$eval(c.stSortDefault) !== e ? r.$eval(c.stSortDefault) : c.stSortDefault), i.bind("click", function () {
          p && r.$apply(o);
    ...
    return { restrict: "EA", require: "^stTable", scope: { stItemsByPage: "=?", stDisplayedPages: "=?", stPageChange: "&" }, templateUrl: function templateUrl(e, a) {
        return a.stTemplate ? a.stTemplate : t.pagination.template;
      }, link: function link(e, a, n, s) {
        function r() {
          var t,
              a,
              n = s.tableState().pagination,
              r = 1,
              i = e.currentPage;for (e.totalItemCount = n.totalItemCount, e.currentPage = Math.floor(n.start / n.number) + 1, (t = (r = Math.max(r, e.currentPage - Math.abs(Math.floor(e.stDisplayedPages / 2)))) + e.stDisplayedPages) > n.numberOfPages && (t = n.numberOfPages + 1, r = Math.max(1, t - e.stDisplayedPages)), e.pages = [], e.numPages = n.numberOfPages, a = r; a < t; a++) {
            e.pages.push(a);
    ...
    return { require: "stTable", scope: { stPipe: "=" }, link: { pre: function pre(n, s, r, i) {
          var c = null;t.isFunction(n.stPipe) && (i.preventPipeOnWatch(), i.pipe = function () {
            return null !== c && a.cancel(c), c = a(function () {
              n.stPipe(i.tableState(), i);
            }, e.pipe.delay);
          });
        }, post: function post(t, e, a, n) {
          n.pipe();
        } } };
  }]);
}(angular);
